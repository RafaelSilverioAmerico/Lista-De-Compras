...
public class ProdutoGUI extends Application {
	...
	public void start(Stage palco) {
	   ...
	   palco.setTitle("Gerenciamento de Estoque de Produto");

	   VBox vbox = new VBox();
	   vbox.setPadding(new Insets(10, 10, 10, 10));  // Deixa o espaço interno dos conteners e bordas 
	   ...
	   updateButton.setOnAction(e -> {
	      ...
	      if (selectedProduto != null) {
	          ...
	          limparCampos(); // Limpa os compos de entrada
	        }
	   });
	   ...
	   List<TableColumn<Produto, ?>> columns = List.of(
	    ...
	    buttonBox.getChildren().addAll(addButton, updateButton, deleteButton, clearButton); // Adicionaro botão Limpar ao HBox
	...
	public void stop() {
	   try {
	       conexaoDB.close(); // Fecha a conexao com o banco de dados
	   }
	   catch (SQLException e) {
	       System.err.println("Erro ao tentar conexão" + e.getMessage());
	   }
	}
